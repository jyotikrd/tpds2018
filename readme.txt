...
Run MEKA code on the csv generated file


Split MEKA output file to Train and Test files
./train_test.sh <file.xxx> <n> <d> <fraction assigned to train>
...
Distribute MEKA Training data having <nTrain> samples to <nodes> units, k: new rank from MEKA:
./distribute.sh <trainData.csv> <nTrain> <k> <nodes>
